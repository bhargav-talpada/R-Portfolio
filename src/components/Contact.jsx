...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full h-screen bg-gradient-to-b from-gray-800 to-black p-4 text-white pt-20 md:pt-0"
    >
          ...
          <div className="grid gap-y-7 750:flex items-center">
            ...
            <span className="750:mx-4">
              ...
              <div className="flex text-2xl text-gray-400 gap-3 py-4">
                <a href="https://www.linkedin.com/in/bhargav-talpada-55aa24261/" target="_blank">
                ...
                <a href="/Bhargav cv.pdf" download={true}>
